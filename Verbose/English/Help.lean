...
/--
info: Help
  [apply] The assumption h starts with “∀ n > 0, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h has shape “∃ n > 0, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h has shape “∃ ε > 0, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h starts with “∀ n, ...”
  One can use it with:
  By h applied to n₀ we get (hn₀ : P n₀ → Q n₀)
  where n₀ is a natural number
  The name hn₀ can be chosen freely among available names.
  [apply] If this assumption won't be used again in its general shape, one can also specialize h with
  We apply h to n₀
-/
#guard_msgs in
...
info: Help
  ...
  [apply] If this assumption won't be used again in its general shape, one can also specialize h with
  We apply h to n₀
  [apply] Since the goal is P 2, one can use:
...
/--
info: Help
  [apply] The assumption h is an implication
  ...
  [apply] If one already has a proof H of P 1 then one can use:
...
/--
info: Help
  [apply] The assumption h has shape “... and ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h is an equivalence
  One can use it to replace the left-hand-side (namely ∀ n ≥ 2, P n) by the right-hand side (namely ∀ (l : ℕ), Q l) in the goal with:
  We rewrite using h
  [apply] One can use it to replace the right-hand-side in the goal with:
  We rewrite using ← h
  [apply] One can also perform such replacements in an assumption hyp with
...
/--
info: Help
  [apply] The assumption h has shape « ... or ... »
  One can use it with:
  We proceed using h
-/
#guard_msgs in
...
/--
info: Help
  [apply] This assumption is a contradiction.
...
/--
info: Help
  [apply] The assumption h starts with “∀ k ≥ 2, ∃ n ≥ 3, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h starts with “∀ k n, k ≥ n ⇒ ...
  One can use it with:
...
/--
info: Help
  [apply] The assumption h starts with “∀ k ≥ 2, ∃ n_1 ≥ 3, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h has shape “∃ n ≥ 5, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h has shape “∃ n, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h starts with “∀ k, ∃ n, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h starts with “∀ k ≥ 2, ∃ n, ...”
  One can use it with:
...
/--
info: Help
  [apply] The goal starts with “∀ n ≥ 0”
  Hence a direct proof starts with:
  Fix n ≥ 0
-/
#guard_msgs in
...
/--
info: Help
  [apply] The goal starts with “∀ n : ℕ,”
  Hence a direct proof starts with:
  Fix n : ℕ
-/
#guard_msgs in
...
/--
info: Help
  [apply] The goal starts with “∃ n ≥ 1, ...”
  Hence a direct proof starts with:
...
/--
info: Help
  [apply] The goal is the inclusion s ⊆ t
  Hence a direct proof starts with:
  Fix x ∈ s
  The name x can be chosen freely among available names.
---
info: Help
  [apply] The assumption h ensures the inclusion of s in t.
  One can use it with:
...
/--
info: Help
  [apply] The assumption h claims membership to an intersection
  One can use it with:
...
---
info: Help
  [apply] The goal is prove x belongs to the intersection of t with another set.
  Hance a direct proof starts with:
  Let's first prove that x ∈ t
---
info: Help
  [apply] The next step is to announce:
...
/--
info: Help
  [apply] The assumption h claims membership to a union
  One can use it with:
  We proceed using h
---
info: Help
  [apply] The goal is to prove x belongs to the union of t and s.
  Hence a direct proof starts with:
...
/--
info: Help
  [apply] The goal starts with “False ⇒ ...”
  Hence a direct proof starts with:
  Assume hyp : False
  The name hyp can be chosen freely among available names.
-/
...
info: Help
  ...
  Assume hyp : False
  The name hyp can be chosen freely among available names.
  [apply] The goal is an implication.
...
/--
info: Help
  [apply] One can start a proof by contradiction using
...
/--
info: Help
  [apply] The assumption h has shape “∃ x, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h has shape “∃ x ∈ s, ...”
  One can use it with:
...
/--
info: Help
  [apply] The goal is the negation of P, which means P implies a contradiction.
  Hence a direct proof starts with:
  Assume hyp : P
...
/--
info: Help
  [apply] The goal is the negation of  x = y, which means x = y implies a contradiction.
  Hence a direct proof starts with:
  Assume hyp : x = y
  And then it will remain to prove a contradiction.
-/
...
/--
info: Help
  [apply] Assumption h is an implication
  The conclusion of this implication is the current goal
  Hence one can use this assumption with:
  Since P 1 → Q 2 it suffices to prove that P 1
  [apply] If you already have a proof of P 1 then one can use:
...
info: Help
  ...
  [apply] One can also perform such replacements in a statement following from one of the current assumptions with
...
/--
info: Help
  [apply] The assumption h starts with “∀ x, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h starts with “∀ x > 0, ...”
  One can use it with:
...
/--
info: Help
  [apply] The assumption h is an inequality
...
/--
info: Help
  [apply] The goal is an inequality
  ...
  must chain to give  > ⏎
  [apply] If this inequality follows immediately from an assumption, one can use:
...
/--
info: Help
  [apply] The assumption h ensures the inclusion of _uniq.129282 in B.
  One can use it with:
...
/--
info: Help
  [apply] The goal is to prove a contradiction.
  ...
  [apply] One can also invoke a clearly false fact (such as `0 = 1`) that follows directly from an assumption.
