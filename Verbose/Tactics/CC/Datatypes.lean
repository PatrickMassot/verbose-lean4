...
In addition to the conditions in `Verbose.Tactics.CC.isValue`, this also checks that
...
initialize
  registerTraceClass `Verbose.Meta.Tactic.cc.merge
  registerTraceClass `Verbose.Meta.Tactic.cc.failure
  registerTraceClass `Verbose.Debug.Meta.Tactic.cc
  registerTraceClass `Verbose.Debug.Meta.Tactic.cc.ac
  registerTraceClass `Verbose.Debug.Meta.Tactic.cc.parentOccs
